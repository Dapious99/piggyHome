...
const Heroleft = () => {
  return (
    <div className='w-[50%] sm:w-[100%] sm:px-2'>
        <div className='py-[2.5rem] sm:text-center'>
            <p className='font-bold text-[4.3rem] sm:text-[3rem]'>The Better Way to Save & Invest.</p>
            <p className='font-normal text-[1.3rem] sm:text-[20px] pt-2 pb-5'>PiggyVest helps over 4 million customers achieve their financial goals by helping them save and invest with ease.</p>
